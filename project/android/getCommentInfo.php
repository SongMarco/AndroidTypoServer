...
// 댓글 하나의 정보를 불러오는 php
// 답글 알림을 통해 답글 액티비티로 접근한 경우,
// 답글이 달린 댓글의 정보를 가져오기 위해 만들었다.


$commentID = $_POST['commentID'];

// 먼저 DB에서 해당 댓글 ID를 지닌 댓글을 불러온다.
$query = "select * from dbMember2.table_comment WHERE id = '$commentID' AND depth = 1";
