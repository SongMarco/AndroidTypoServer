...
// 뉴스피드 한 개의 정보를 불러오는 php
//알림을 통해 답글에 접근했을 때, 게시물의 정보를 얻기 위해 만들었다.

$feedID = $_POST['feedID'];


// 먼저 DB에서 feedID를 지닌 뉴스피드를 가져온다.
$query = "select * from dbMember2.table_newsfeed WHERE id = '$feedID' ";
...
//    echo 'type'.$type.'typeID'.$typeID.'email'.$email;
